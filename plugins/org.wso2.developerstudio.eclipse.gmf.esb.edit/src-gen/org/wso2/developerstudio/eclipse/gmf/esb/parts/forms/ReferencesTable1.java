 ...
 */
public class ReferencesTable1 implements IPropertiesFilteredWidget {
     ...
     */
    private ReferencesTableListener1 referencesTableListener;
    ...
    private Composite tableHeaderComposite;
     ...
     */
    public ReferencesTable1(String labeltoDisplay, String tableHeaderLabel,ReferencesTableListener1 referenceListener) {
        this.labelToDisplay = labeltoDisplay;
        this.headerLabel = tableHeaderLabel;
    ...
    public void addTableReferenceListener(ReferencesTableListener1 referenceListener) {
    ...
    public void createControls(Composite parent) {
        ...
        // ///////////////////////////////////////////////////////////////////////////
        // Create and place Table header  
        tableHeaderComposite = new Composite(composite, SWT.BORDER);

        FormLayout tableHeaderLayout = new FormLayout();
        tableHeaderComposite.setLayout(tableHeaderLayout);
        FormData connectionTypeGroupLayoutData = new FormData();
        connectionTypeGroupLayoutData.top = new FormAttachment(label,5);
        connectionTypeGroupLayoutData.left = new FormAttachment(0,ITabbedPropertyConstants.HSPACE);
        connectionTypeGroupLayoutData.right = new FormAttachment(100, -ITabbedPropertyConstants.HSPACE);
        tableHeaderComposite.setLayoutData(connectionTypeGroupLayoutData);
           
        Label tableHeaderLabel = new Label(tableHeaderComposite,SWT.NONE);
        tableHeaderLabel.setText(headerLabel);
        tableHeaderLabel.setFont(FontUtils.getMonospacedFont());
        ...
        data = new FormData();
        data.height = 100;
        data.top = new FormAttachment(tableHeaderComposite, 0);
    ...
    public interface ReferencesTableListener1 {
